...
namespace MonadicPipeline.Android.UITests
{
    ...
    public class MainPageTests
    {
        ...
        public void AppLaunches_ShouldDisplayWelcomeScreen()
        {
            ...
            Assert.That(welcomeMessage.Text, Does.Contain("MonadicPipeline CLI"));
        }
        ...
        public void PurpleScreenBugFix_DatabaseError_ShouldStillShowUI()
        {
            ...
            Assert.That(text, Does.Contain("MonadicPipeline CLI").Or.Contains("⚠ Initialization error"));
...
public static IApp ConfigureApp
{
    get
    {
        return ConfigureApp
            .Android
            .ApkFile("../../../com.adaptivesystems.monadicpipeline.apk")
...
namespace MonadicPipeline.Android.AppiumTests
{
    public class MainPageAppiumTests : IDisposable
    {
        ...
        public void AppLaunches_NoP urpleScreen_UIIsVisible()
        {
            ...
            Assert.Contains("MonadicPipeline CLI", outputLabel.Text);
        }
...
jobs:
  ui-tests:
    ...
    - name: Run Xamarin.UITest
      run: |
        cd src/MonadicPipeline.Android.UITests
...
### For the MonadicPipeline Android App:
