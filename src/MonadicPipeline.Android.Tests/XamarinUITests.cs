...
namespace MonadicPipeline.Android.Tests.UIAutomation;
...
public class XamarinUITests
{
    ...
    public void AppLaunches_ShouldDisplayWelcomeScreen()
    {
        ...
        Assert.That(outputText, Does.Contain("MonadicPipeline CLI"), "Welcome message must be displayed");
    }
    ...
    public void PurpleScreenBugFix_InitializationError_UIStillRenders()
    {
        ...
        var hasWelcomeMessage = outputText!.Contains("MonadicPipeline CLI");
