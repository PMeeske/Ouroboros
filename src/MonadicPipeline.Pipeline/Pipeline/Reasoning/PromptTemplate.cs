// <copyright file="PromptTemplate.cs" company="PlaceholderCompany">
...
{
    private readonly string template = template ?? throw new ArgumentNullException(nameof(template));
    ...
    public Result<string> SafeFormat(Dictionary<string, string> vars)
    {
        ...
        try
        {
            ...
            var placeholders = ExtractPlaceholders(this.template);
    ...
    /// </summary>
    public IReadOnlyList<string> RequiredVariables => ExtractPlaceholders(this.template);
}
